...
#define EI_CLASSIFIER_PROJECT_ID                 991408
#define EI_CLASSIFIER_PROJECT_OWNER              "lyy111"
#define EI_CLASSIFIER_PROJECT_NAME               "lyy111-project-1"
...
#define EI_CLASSIFIER_FUSION_AXES_STRING         "flex1 + flex2 + flex3 + flex4 + flex5 + flex6 + flex7 + flex8 + flex9 + flex10 + accX + accY + accZ + gyroX + gyroY + gyroZ"
...
#define EI_CLASSIFIER_TFLITE_LARGEST_ARENA_SIZE     4844
